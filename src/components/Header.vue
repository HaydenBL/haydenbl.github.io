    ...
    >
      ...
      <div class="bg-red-500 py-2 -mt-px">
        ...
        >
          ...
          <!-- Github -->
          <a href="https://github.com/HaydenBL" target="_blank" class="transform transition-transform ease-in-out duration-200 hover:scale-110 hover:rotate-6">
            <svg class="h-8 w-8 sm:h-10 sm:w-10" xmlns="http://www.w3.org/2000/svg" fill="white" stroke="none" viewBox="0 0 24 24" role="img">
      ...
      <div class="-mt-px">
        <TransitionChild as="span"
                         class="inline-block w-[80rem] pb-3 pr-2 text-right bg-red-500"
                         enter="transition-all ease-out duration-500"
                         enterFrom="w-[0]"
        >
          Hayden
