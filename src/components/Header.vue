  ...
  <TransitionRoot as="div"
    ...
    >
      ...
      <div class="bg-red-500 py-2 -mt-px flex">
        ...
        >
          <!-- Instagram -->
          <a href="https://www.instagram.com/hayden_blaise/" target="_blank" class="transform transition-transform ease-in-out duration-300 hover:scale-110 hover:rotate-6">
            <svg class="h-8 w-8 sm:h-10 sm:w-10" xmlns="http://www.w3.org/2000/svg" fill="white" stroke="none" viewBox="0 0 24 24" role="img">
          ...
          <!-- Github -->
          <a href="https://github.com/HaydenBL" target="_blank" class="transform transition-transform ease-in-out duration-300 hover:scale-110 hover:rotate-6">
            <svg class="h-8 w-8 sm:h-10 sm:w-10" xmlns="http://www.w3.org/2000/svg" fill="white" stroke="none" viewBox="0 0 24 24" role="img">
      ...
      >
        ...
        <span class="text-gray-600 pl-2 pb-3 flex-grow">Lueck</span>
      </TransitionChild>
    </div>
  </TransitionRoot>
